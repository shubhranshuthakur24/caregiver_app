...
import 'package:givershealths/care_giver_app/screens/calander/custom_calander/avilabe_slot_widget.dart';

import '../calendar_services.dart';
import 'navigator_name_widget.dart';
...
///   * [errorFormatText], message_screens used when the input text isn't in a proper date format.
///   * [errorInvalidText], message_screens used when the input text isn't a selectable date.
...
class _DatePickerDialogState extends State<DatePickerDialog>
  ...
  Widget build(BuildContext context) {
    ...
    // Test3.a.value = _selectedDate.value.toString().split(" ")[0];
...
///     mode.
///   * [errorFormatText], the message_screens used when an input text isn't in a proper
///     date format.
///   * [errorInvalidText], the message_screens used when an input text isn't a
///     selectable date.
///   * [errorInvalidRangeText], the message_screens used when the date range is
...
class DateRangePickerDialog extends StatefulWidget {
  ...
  /// The message_screens used when the date range is invalid (e.g. start date is after
  /// end date).
  ///
  /// If null, the localized value of
  ...
  /// The message_screens used when an input text isn't in a proper date format.
  ///
  /// If null, the localized value of
  /// [MaterialLocalizations.invalidDateFormatLabel] is used.
  final String? errorFormatText;

  /// The message_screens used when an input text isn't a selectable date.
  ///
  /// If null, the localized value of
...
class _InputDateRangePickerState extends State<_InputDateRangePicker> {
  ...
  /// return false and display an appropriate error message_screens under one of the
  /// text fields.
  bool validate() {
