...
class AssessmentFormLovedOnesDetilsEXitBackButton extends StatelessWidget {
  availableApiName apiName;

  AssessmentFormLovedOnesDetilsEXitBackButton({required this.apiName, required this.next});

  final VoidCallback next;
  RxBool buttonPressed = false.obs;
  LovedOneDetilasButtonColorChangeWhenAllRequiredFieldAreFilled lovedOneDetilasButtonColorChangeWhenAllRequiredFieldAreFilled =
      Get.find();
          ...
          Expanded(
            child: Obx(() {
              return MaterialButton(
                ...
                color: lovedOneDetilasButtonColorChangeWhenAllRequiredFieldAreFilled.allFieldAllVerifeid.isTrue
                    ? kConstantPurple
