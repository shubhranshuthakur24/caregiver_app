...
import 'assessmentpage_falling_experiences.dart';

class AssessmentPage3 extends StatefulWidget {
  const AssessmentPage3({Key? key}) : super(key: key);

  @override
  _AssessmentPage1State createState() => _AssessmentPage1State();
}

class _AssessmentPage1State extends State<AssessmentPage3> {
  int _selectedIndex = -1;
  List<String> answerList = [
    "Yes, 2 times or more",
    "Yes, once",
    "No, but has been to urgent care",
    "Not in the last month, but has in the last 6 months",
    'Unknown / NA',
  ];

  // In the past month, has your loved one been to an emergency room?

  AssessmentPagesSerivces controllerAssessmentPageServices =
      Get.put(AssessmentPagesSerivces());
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Container(color: kConstantPurple, height: 5.h, width: 34.w),
                Container(color: formLandingColor4, height: 5.h, width: 341.w)
              ],
            ),
            SizedBox(
              height: 24.h,
